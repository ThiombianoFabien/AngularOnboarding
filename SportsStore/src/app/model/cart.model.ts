...
export class Cart {
  ...
  constructor() {
    ...
    this.summary = computed(() => {
      ...
      this.linesSignal().forEach((l) => {
        newSummary.itemCount = newSummary.itemCount + l.quantity;
        newSummary.cartPrice = newSummary.cartPrice + l.lineTotal;
      });
      return newSummary;
    });
  }
  ...
  removeLine(id: number) {
    this.linesSignal.mutate((linesArray) => {
      let lineIndex = linesArray.findIndex((l) => l.product.id == id);
